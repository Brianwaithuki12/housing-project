...
<li class="nav-item bg-info">
        ...
        <li class="nav-item">
          <a class="nav-link text-light" href="profile.php"><p>Pending Orders</p></a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="profile.php?edit_account"><p>Edit Account</p></a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="profile.php?my_orders"><p>My orders</p></a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="profile.php?delete_account"><p>Delete Account</p></a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="logout.php"><p>Logout</p></a>
        </li>
</ul>
    </div>
    <div class="col-md-10">
