                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <div class="form-outline mb-4">
                        ...
                        <input type="file" id="user_email" class="form-control"
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="user_contact" class="form-control"
                         placeholder="Enter your Contact" autocomplete="off" required name="user_contact">
                        
                    </div>

                    <div class="mt-4 pt-2 mb-0">
                        <input type="submit" value="Register" class="bg-info py-2 px-3 border-0" name="user_register">
                        <p class="small fw-bold mt-2 pt-1">Already have an account ? <a href="users_login.php" class="text-danger">Login</a></p>
                    </div>
                </form>
            </div>
        </div>
