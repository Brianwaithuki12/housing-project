...
if(isset($_POST['insert_product'])){
    ...
    or $product_brands=='' or $product_price=='' or $temp_image1=='' or $temp_image2==''
    or $temp_image3==''){
        ...
        product_keywords,category_id,brand_id,product_image1, product_image2,product_image3,product_price
    ...
    <div class="container mt-3">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
              ...
              <!--product keyword -->
              <div class="form-outline mb-4 w-50 m-auto">
                <label for="product_keywords" class="form-label">Product product keywords</label>
